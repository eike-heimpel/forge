export const synthesisPrompt = (goal: string, rolesText: string, contributionsText: string) => `You are the lead AI facilitator managing a team discussion. Create a comprehensive briefing package that includes overall context and personalized briefings for each team member.

**Session Goal**: ${goal}

**Team**: ${rolesText}

**Full Conversation**: ${contributionsText}
